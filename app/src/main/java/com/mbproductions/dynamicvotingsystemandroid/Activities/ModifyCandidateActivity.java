...
public class ModifyCandidateActivity extends AppCompatActivity {
    ...
    private void init() {
        modify_btn = findViewById(R.id.add_button_modify);
        CName_input = findViewById(R.id.CandidateNameModify_input);
        gender_spinner = findViewById(R.id.genderModify_spinner);
        ...
        modify_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (a != "") {
                    ...
                    ModifyCandidateActivity.ModifyCandidateAsync mc = new ModifyCandidateActivity.ModifyCandidateAsync();
                    mc.execute("");

                } else {
                    Toast.makeText(ModifyCandidateActivity.this, "Please enter a Name", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }

    public class ModifyCandidateAsync extends AsyncTask {
        ...
        protected Void doInBackground(Object... objects) {
            ...
            try {
                ...
                Log.d("Maleeeee", String.valueOf(isMale));
                ...
                votingSystem.modifyCandidate(BigInteger.valueOf(MainActivity.itemtoremove),modifiedname, isMale).send();
                ...
                runOnUiThread(new Runnable() {
                    ...
                    public void run() {
                        ...
                        finish();
                        Intent intent = new Intent(ModifyCandidateActivity.this,MainActivity.class);
            ...
            Log.d("done editing", "donez editing candidate");
